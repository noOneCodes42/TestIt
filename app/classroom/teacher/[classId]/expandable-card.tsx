      ...
      <AnimatePresence>
        {active && typeof active === "object" && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/20 h-screen w-screen z-10"
          />
        )}
      </AnimatePresence>
      <AnimatePresence>
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-100">
            ...
            <motion.div
              ...
              ref={ref}
              className="w-full max-w-[750px] h-full flex flex-col bg-neutral-600 sm:rounded-3xl overflow-hidden"
            >
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="p-4 flex flex-col md:flex-row justify-between items-center bg-neutral-600 hover:bg-neutral-800 rounded-xl cursor-pointer"
          >
